...
export default function InternshipModal({ internship, onClose, onConfirmApply }) {
  ...
  // Opens the assessment overlay instead of applying directly
  const handleApply = () => setShowAssessment(true);

  // Called by SkillAssessment after it successfully posts the application
  ...
  return (
    <>
      ...
      {/* ── Skill Assessment overlay (renders on top of everything) ── */}
      {showAssessment && (
        <SkillAssessment
